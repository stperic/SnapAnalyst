...
class TestFormatSearchScope:
    ...
    def test_format_kb_scope(self):
        ...
        filters = {"chromadb_path": "kb", "collections": ["kb"], "tags": [], "category": None, "user_scope": "all"}
    ...
    def test_format_with_private_scope(self):
        ...
        filters = {"chromadb_path": "kb", "collections": ["kb"], "tags": [], "category": None, "user_scope": "private"}
