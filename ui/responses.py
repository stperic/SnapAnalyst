...
from .config import APP_PERSONA, AI_PERSONA
...
async def filter_applied_message(state: Optional[str], year: Optional[int]) -> cl.Message:
...
async def training_disabled_message(cleaned: bool = True, error: Optional[str] = None) -> cl.Message:
