        ...
        if fk_constraints:
            ...
            for fk in fk_constraints:
                ...
                schema["relationships"][rel_name] = {
                    ...
                    "description": f"Foreign key relationship"
                }
...
def _merge_schema_with_docs(db_schema: Dict, docs: Dict) -> Dict:
    ...
    for db_rel_name, db_rel_info in merged["relationships"].items():
...
def _format_as_markdown(columns: List[str], data: List[Dict[str, Any]]) -> str:
...
def _format_as_csv(columns: List[str], data: List[Dict[str, Any]]) -> str:
