...
class CSVReader:
    ...
    def read_csv(
        ...
        Args:
            batch_size: If specified, read in batches (not used in Polars, kept for compatibility)
    ...
    def get_row_count(self) -> int:
        ...
        """
        try:
            # Fast row count using Polars
            df = pl.read_csv(self.file_path, n_rows=0)  # Read only to get structure
            # Then count with lazy loading
