    ...
    def get_demographics_statistics(
        ...
        try:
            ...
            indicators = query.with_entities(
                func.count(case((HouseholdMember.disability_indicator == True, 1))).label('with_disability'),
                func.count(case((HouseholdMember.working_indicator == True, 1))).label('working'),
            ).first()
